                        ...
                        <div class="col-md-4 offset-md-4">
                            <form action="{{ url('programs') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    is-invalid @enderror">
                                        ...
                                        @foreach ($edulevel as $item)
                                            <option value="{{ $item->id }}" {{ old('edulevel_id') == $item->id ? 'selected' : null }} >{{ $item->nama}}</option>
                                        @endforeach
                                    </select>
                                    @error('edulevel_id')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    is-invalid @enderror" value="{{ old('student_price') }}" autofocus>
                                    @error('student_price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    is-invalid @enderror" value="{{ old('student_max') }}" autofocus>
                                    @error('student_max')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    is-invalid @enderror">{{ old('info') }}</textarea>
                                    @error('info')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
