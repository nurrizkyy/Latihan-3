                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('fulls') }}" method="post">
                                                @csrf
                        ...
                        @foreach ($full as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('fulls/' . $item->id) }}" class="btn btn-warning btn-sm">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    <a href="{{ url('fulls/' . $item->id) . '/edit' }}" class="btn btn-primary btn-sm">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ url('fulls/' . $item->id) }}" method="post" class="d-inline"
